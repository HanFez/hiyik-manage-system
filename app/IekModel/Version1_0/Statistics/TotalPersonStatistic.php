 ...
 */
class TotalPersonStatistic extends IekModel{

    protected $table = 'viewTotalPersonStatistics';
     ...
     */
    public static function orderByStatistics(array $personIds, $order='desc') {
