 ...
 * Class TotalPersonPublicationView
 * @package App\IekModel\Version1_0
 */
class TotalPersonPublicationView extends IekModel{

    protected $table = 'viewTotalPersonPublicationViews';
    public $incrementing = false;
    public $timestamps = false;
    public $primaryKey = 'uid';

    /**Order person according to total publication view count
     * @param array $personIds The id array of person
     * @param string $order
     * @return array The ordered id array of persons
     */
    public static function orderByViews(array $personIds, $order='desc') {
