 ...
 * Time: 16:42
 */
namespace App\Http\Controllers\RefundAPI;

use App\Http\Controllers\AliPayTransfer\AopEncrypt;
use App\Http\Controllers\AliPayTransfer\LtInflector;
use App\Http\Controllers\AliPayTransfer\LtLogger;
use League\Flysystem\Exception;

class AopClient{

    //应用ID
    public $appId = '2017020805571511';

    //私钥文件路径
    public $rsaPrivateKeyFilePath;

    //私钥值
    public $rsaPrivateKey = '';
